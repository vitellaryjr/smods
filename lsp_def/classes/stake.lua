...
---@field calc_dollar_bonus? fun(self: SMODS.Stake|table): nil|number, {text?:string, text_colour?:table, scale?:number, key?:string, set?:string} Calculates reward money. 
